...
from cbrextra.ncbi.openapi.api_client import ApiClient, RequestSerialized
from cbrextra.ncbi.openapi.api_response import ApiResponse
from cbrextra.ncbi.openapi.rest import RESTResponseType
...
class GenomeApi:
    ...
    def check_assembly_availability(
        ...
        exp_debug_values: Annotated[Optional[StrictStr], Field(description="Supports debugging, e.g. by controlling data download speeds")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param exp_debug_values: Supports debugging, e.g. by controlling data download speeds
        :type exp_debug_values: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._check_assembly_availability_serialize(
            ...
            exp_debug_values=exp_debug_values,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _check_assembly_availability_serialize(
        ...
        # process the query parameters
        if exp_debug_values is not None:
            
            _query_params.append(('_exp_debug_values', exp_debug_values))
