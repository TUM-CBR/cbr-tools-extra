...
class V2TaxonomyNode(BaseModel):
    ...
    indexed_names: Optional[List[StrictStr]] = Field(default=None, alias="_indexed_names")
    __properties: ClassVar[List[str]] = ["tax_id", "organism_name", "common_name", "genbank_common_name", "acronyms", "genbank_acronym", "blast_name", "lineage", "children", "descendent_with_described_species_names_count", "rank", "has_described_species_name", "counts", "min_ord", "max_ord", "extinct", "genomic_moltype", "_indexed_names"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_indexed_names": obj.get("_indexed_names")
        })
        return _obj
