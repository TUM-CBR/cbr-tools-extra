...
class V2reportsAssemblyInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["assembly_level", "assembly_status", "paired_assembly", "assembly_name", "assembly_type", "bioproject_lineage", "bioproject_accession", "submission_date", "release_date", "description", "submitter", "refseq_category", "synonym", "linked_assembly", "linked_assemblies", "atypical", "genome_notes", "sequencing_tech", "assembly_method", "biosample", "blast_url", "comments", "suppression_reason", "diploid_role"]
