...
class V2VirusDatasetRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accessions", "taxon", "refseq_only", "annotated_only", "released_since", "updated_since", "host", "pangolin_classification", "geo_location", "complete_only", "table_fields", "include_sequence", "aux_report", "format", "use_psg"]
