...
class V2MicroBiggeDatasetRequest(BaseModel):
    ...
    element_flank_config: Optional[V2MicroBiggeDatasetRequestElementFlankConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "files": obj.get("files"),
            "element_flank_config": V2MicroBiggeDatasetRequestElementFlankConfig.from_dict(obj["element_flank_config"]) if obj.get("element_flank_config") is not None else None
        })
        return _obj
