...
class V2Sars2ProteinDatasetRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["proteins", "refseq_only", "annotated_only", "released_since", "updated_since", "host", "geo_location", "complete_only", "table_fields", "include_sequence", "aux_report", "format"]
