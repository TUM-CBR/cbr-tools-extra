...
class V2VirusDatasetFilter(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accessions", "taxon", "refseq_only", "annotated_only", "released_since", "updated_since", "host", "pangolin_classification", "geo_location", "complete_only"]
